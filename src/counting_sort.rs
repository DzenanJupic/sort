...
impl_counting_sort!(impl CountingSort for [char] in range u8::MIN as char => u8::MAX as char);

impl_counting_sort!(impl CountingSort for [u8] in range u8::MIN => u8::MAX);
impl_counting_sort!(impl CountingSort for [i8] in range i8::MIN => i8::MAX);
#[cfg(feature = "counting-sort-16")]
impl_counting_sort!(impl CountingSort for [u16] in range u16::MIN => u16::MAX);
#[cfg(feature = "counting-sort-16")]
impl_counting_sort!(impl CountingSort for [i16] in range i16::MIN => i16::MAX);
#[cfg(feature = "counting-sort-32")]
impl_counting_sort!(impl CountingSort for [u32] in range u32::MIN => u32::MAX);
#[cfg(feature = "counting-sort-32")]
impl_counting_sort!(impl CountingSort for [i32] in range i32::MIN => i32::MAX);
